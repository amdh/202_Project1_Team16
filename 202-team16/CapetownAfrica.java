...
public class CapetownAfrica extends IPlace
{
    ...
    public CapetownAfrica()
    {
        ...
        textHintPath = "Hint1: Da Vinci Code was shot in it's capital city ";
    ...
    public  void doIncorrectAnswer(){
        //remove life and repaint the screen
            ...
            if(hint==2){
                ...
                world.showHint2(hintImg,"Hint2: Romance Capital of the world?");
                //hint = hint +1;
            }
            else if(hint==3){
                //playsound
                ...
                world.showHint3("Hint3: Try to guess the place from this audio..");
                audioHint.play();
            }
    }
